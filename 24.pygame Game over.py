...
background = pygame.image.load("C:\\Users\ACER\PycharmProjects\pythonProject\Sudheer sir\Class 16\Space invaders\space.jpg")
#baground music
mixer.music.load("Art of Silence.wav")
mixer.music.play(-1)
# title and icon
...
for i in range(num_of_enemies):
    enemyImg.append(pygame.image.load("mushroom.png"))
